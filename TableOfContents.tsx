...
export default function TableOfContents() {
  ...
  const handleScroll = useCallback(() => {
    ...
    setProgress(Math.min(100, (scrolled / article.offsetHeight) * 100));
    let current = "";
  ...
  return (
    <>
      {/* Desktop: fixed kiri, top=96px agar tidak nabrak sticky nav */}
      <aside
        className="hidden xl:flex flex-col fixed left-6 z-40 w-56"
        style={{ top: "96px", maxHeight: "calc(100vh - 120px)" }}
      >
              ...
              return (
                <li key={h.id}>
                  ...
                  >
                    ...
                    <span className={`text-xs leading-snug font-medium transition-colors duration-200 line-clamp-2 ${
