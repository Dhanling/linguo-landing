/**
 * fix-student-redirect2.mjs
 * 
 * Jalankan:
 *   cd ~/linguo-landing && node fix-student-redirect2.mjs && rm fix-student-redirect2.mjs && git add -A && git commit -m "feat: student login auto-redirect to portal" && git push
 */

import fs from "fs";
import path from "path";

const dashDir = path.join("src", "app", "student", "dashboard");
...
fs.writeFileSync(path.join(dashDir, "page.tsx"), code);
console.log("✅ /student/dashboard/page.tsx — written (auto-redirect to portal)");
