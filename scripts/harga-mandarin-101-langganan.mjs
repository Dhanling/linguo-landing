#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "Mandarin 101 new edition"
// berformat langganan, sama seperti Japanese 101, Spanish 101, English 101 &
// Italiano 101 new edition.
//
// Baris "Lifetime Rp99.000" adalah warisan baris katalog modul Mandarin lama
// (slug modul-mandarin-101-id dipakai ulang oleh edisi baru). Baris itu
...
//
// Pakai: node scripts/harga-mandarin-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260823-harga-mandarin-101-langganan.sql
...
const PID = "8faa533c-9222-4d95-946d-8fb58f67894d"; // modul-mandarin-101-id
const TIER_LAMA = "ceb60fae-9c6b-4df4-aba3-fe0582fa3cf2"; // Lifetime Rp99.000
