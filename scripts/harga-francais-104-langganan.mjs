...
// "Français 104 new edition" (tingkat B2) — harganya disamakan persis dengan
// Français 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B2 ini baris katalognya BARU (slug francais-104-b2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-francais-104-langganan.mjs
// Kembarannya dalam SQL: sql/20260828-harga-francais-104-langganan.sql
...
const PID = "e2c3cc5f-f522-461a-9f76-a83cbba265fb"; // francais-104-b2-id
