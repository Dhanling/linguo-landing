...
// "Hebrew 101 new edition" — pola yang sama dengan Japanese, Spanish, English,
// German, Italiano, Mandarin, Français, Dansk, Korean, Russian, Magyar,
// Georgian, Vietnam, Íslenska & Português do Brasil 101 new edition.
//
// Baris katalognya BARU (modul-hebrew-101-id) — bukan warisan modul lama — jadi
// tak ada tier "Lifetime Rp99.000" yang perlu diarsipkan. Baris warisan
// `modul-hebrew-101-en` sengaja TIDAK disentuh: itu edisi bahasa Inggris
// (link Drive), produk yang berbeda dari modul edisi Indonesia ini.
//
// Pakai: node scripts/harga-hebrew-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-hebrew-101-langganan.sql
...
const PID = "cbf71b0c-ef35-4a49-9619-f075e7b19731"; // modul-hebrew-101-id
