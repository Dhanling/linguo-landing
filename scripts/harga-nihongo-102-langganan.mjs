...
// "日本語 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// 日本語 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug nihongo-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-nihongo-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-nihongo-102-langganan.sql
...
const PID = "7b2d9143-2b4e-4ce7-9531-e1b91682c17c"; // nihongo-102-a2-id
