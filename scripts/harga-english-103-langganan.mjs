...
// "English 103 new edition" (tingkat B1) — harganya disamakan persis dengan
// English 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B1 ini baris katalognya BARU (slug english-103-b1-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-english-103-langganan.mjs
// Kembarannya dalam SQL: sql/20260826-harga-english-103-langganan.sql
...
const PID = "7b87a876-889b-48ed-972b-f5d01c0062ab"; // english-103-b1-id
