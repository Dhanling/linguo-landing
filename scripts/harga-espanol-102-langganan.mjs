...
// "Spanish 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// Spanish 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug espanol-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-espanol-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260825-harga-espanol-102-langganan.sql
...
const PID = "abd4aaf6-6a56-498f-ae13-86d69f4ad188"; // espanol-102-a2-id
