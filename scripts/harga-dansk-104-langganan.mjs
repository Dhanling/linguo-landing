...
// "Dansk 104 new edition" (tingkat B2) — harganya disamakan persis dengan
// Dansk 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B2 ini baris katalognya BARU (slug dansk-104-b2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-dansk-104-langganan.mjs
// Kembarannya dalam SQL: sql/20260830-harga-dansk-104-langganan.sql
...
const PID = "4d094d95-37b1-42dd-8a1e-e2e263c15fb4"; // dansk-104-b2-id
