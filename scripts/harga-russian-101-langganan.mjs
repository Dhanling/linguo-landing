#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "Russian 101 new edition"
// berformat langganan, sama seperti Japanese 101, Spanish 101, English 101,
// Deutsch 101, Mandarin 101, Italiano 101, Français 101, Korean 101 & Dansk 101.
//
// Baris "Lifetime Rp99.000" adalah warisan baris katalog modul Rusia lama
// (slug modul-rusia-101-id dipakai ulang oleh edisi baru). Baris itu
...
//
// Pakai: node scripts/harga-russian-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-russian-101-langganan.sql
...
const PID = "65a0eb7d-1e09-4246-ba48-1aa31934c0f9"; // modul-rusia-101-id
const TIER_LAMA = "94e9b92c-031c-448b-98fb-addc3cefd181"; // Lifetime Rp99.000
