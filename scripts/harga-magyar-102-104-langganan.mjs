...
// "Magyar 101 new edition" A2 · B1 · B2 — pola sama dengan A1
// (lihat scripts/harga-polski-102-104-langganan.mjs): 6 bln 79rb / 12 bln 149rb / selamanya 249rb.
//
// Slug baru semua (Hungaria belum pernah punya baris A2/B1/B2 — A1 "modul-hungaria-101-id" dan edisi lama "modul-hungaria-101-en" A1-B1 tetap sendiri), jadi tak ada tier
// warisan yang perlu diarsipkan. Produk dicari lewat slug, aman dijalankan ulang.
//
// Pakai: node scripts/harga-magyar-102-104-langganan.mjs [slug …]
// Kembarannya dalam SQL: sql/20260925-harga-magyar-102-104-langganan.sql
...
const SLUG = process.argv.slice(2).length
  ...
  : ["magyar-102-a2-id", "magyar-103-b1-id", "magyar-104-b2-id"];
