...
// "Kiswahili 101 new edition" — pola yang sama dengan Japanese, Spanish, English, Dansk,
// German, Italiano, Norsk, Suomi & Nederlands 101 new edition.
//
// Katalog memang sudah punya baris `modul-swahili-101-en` (edisi Inggris, file_url
// masih placeholder.pdf, nol pembeli), tapi baris itu SENGAJA tidak dipakai ulang —
// beda bahasa pengantar, beda level, dan pola `-en` di semua bahasa lain memang
// dibiarkan berdampingan dengan baris `-id`. Tier "Lifetime Rp79.000" miliknya pun
// tidak disentuh. Skrip ini murni memasang tiga tier baru untuk produk yang baru lahir.
//
// Pakai: node scripts/harga-swahili-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260825-harga-swahili-101-langganan.sql
...
const PID = "2f2dc79e-3cd4-4e91-b995-f5f81dcd3bee"; // modul-swahili-101-id
