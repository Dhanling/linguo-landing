#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "German 101 new edition"
// berformat langganan, sama seperti Japanese 101, Spanish 101, English 101 & Italiano 101 new edition.
//
// Baris "Lifetime Rp99.000" adalah warisan baris katalog modul Jerman lama
// (slug modul-jerman-101-id dipakai ulang oleh edisi baru). Baris itu
...
//
// Pakai: node scripts/harga-german-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260823-harga-german-101-langganan.sql
...
const PID = "c94c91d3-2b53-42c2-be50-cc0b915bf3e1"; // modul-jerman-101-id
const TIER_LAMA = "0576d05a-5557-4e3d-b2c2-60423daac6e8"; // Lifetime Rp99.000
