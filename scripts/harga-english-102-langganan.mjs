...
// "English 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// English 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug english-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-english-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260826-harga-english-102-langganan.sql
...
const PID = "e42efe91-3627-48ef-9503-11a79ea7f058"; // english-102-a2-id
