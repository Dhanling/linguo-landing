#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "Dutch 101 new edition"
// berformat langganan, sama seperti Japanese 101, Spanish 101, English 101, Deutsch, Mandarin, Italiano, Korean & Dansk new edition.
//
// Baris "Lifetime Rp99.000" adalah warisan baris katalog modul Belanda lama
// (slug modul-belanda-101-id dipakai ulang oleh edisi baru). Baris itu
...
//
// Pakai: node scripts/harga-dutch-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-dutch-101-langganan.sql
...
const PID = "8e32c0ad-cc9e-4193-97f5-8c3bac51cd95"; // modul-belanda-101-id
const TIER_LAMA = "15d7ed08-16a1-4d8c-b2d5-9942a68c0c75"; // Lifetime Rp99.000
