#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "Bahasa Melayu 101 new edition"
...
//
// Modul bahasa Melayu PERTAMA di katalog — sebelum ini tak ada satu pun baris
// digital_products berbahasa Melayu, jadi tak ada tier warisan yang perlu
// diarsipkan dan tak ada slug lama yang perlu dijaga.
//
// Pakai: node scripts/harga-melayu-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260825-harga-melayu-101-langganan.sql
...
const PID = "247046f0-0504-4c86-ae31-9c924533512a"; // modul-melayu-101-id
