...
// "Mandarin 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// Mandarin 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug mandarin-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-mandarin-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260828-harga-mandarin-102-langganan.sql
...
const PID = "0c21d8e6-a831-43c5-9428-d171030bc2be"; // mandarin-102-a2-id
