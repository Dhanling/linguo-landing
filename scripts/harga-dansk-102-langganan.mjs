...
// "Dansk 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// Dansk 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug dansk-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-dansk-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-dansk-102-langganan.sql
...
const PID = "b44ef8cb-5d46-4338-87db-b64e40b82b3e"; // dansk-102-a2-id
