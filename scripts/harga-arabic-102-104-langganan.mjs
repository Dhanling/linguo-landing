...
// "العربية 101 new edition" (Arab Fusha) A2 · B1 · B2 — pola sama dengan A1
// (scripts/harga-arab-101-langganan.mjs (pola yang sama)): 6 bln 79rb / 12 bln 149rb / selamanya 249rb.
//
// Slug baru semua (Arab Fusha belum pernah punya baris A2/B1/B2 — edisi lama "modul-arab-101-en" A1-B1 tetap sendiri), jadi tak ada tier
// warisan yang perlu diarsipkan. Produk dicari lewat slug, aman dijalankan ulang.
//
// Pakai: node scripts/harga-arabic-102-104-langganan.mjs [slug …]
// Kembarannya dalam SQL: sql/20260924-harga-arabic-102-104-langganan.sql
...
const SLUG = process.argv.slice(2).length
  ...
  : ["arabic-102-a2-id", "arabic-103-b1-id", "arabic-104-b2-id"];
