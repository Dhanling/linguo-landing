...
// "Greek 101 new edition" — pola yang sama dengan Japanese, Spanish, English, Dansk,
// German, Italiano, Norsk, Suomi, Nederlands, Georgian & Hindi 101 new edition.
//
// Baris ID-nya BARU: katalog cuma punya `modul-yunani-101-en` (edisi Inggris,
// masih placeholder berisi link Google Drive) dan tak pernah punya
// `modul-yunani-101-id`. Jadi produknya di-INSERT oleh ebook-publish, dan skrip
// ini murni memasang tiga tier baru — tak ada warisan "Lifetime Rp99.000" yang
// perlu diarsipkan seperti pada Magyar atau Russian.
//
// Pakai: node scripts/harga-greek-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260825-harga-greek-101-langganan.sql
...
const PID = "24d45e8d-0ef0-4017-9e1d-e2d9b00d3396"; // modul-yunani-101-id
