...
// "Levantine Arabic 101 new edition" — pola yang sama dengan Japanese, Spanish,
// English, Dansk, German, Georgian, Uzbek, Khmer, Eesti & Mongolia 101.
//
// Modul ini memakai pola Khmer/Georgian/Mongolia, bukan pola Français/English:
// katalog BELUM pernah punya produk bahasa Arab Syam (Levantine) sama sekali —
// pencarian slug/title/language berisi "levant" mengembalikan [] (dicek 27 Agu
// 2026). Baris "Arabic" yang sudah ada adalah modul **Fusha**, produk yang
// berbeda dan sengaja tidak disentuh sama sekali.
//
// Pakai: node scripts/harga-arab-syam-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260827-harga-arab-syam-101-langganan.sql
...
const PID = "fcc4a04d-e504-4603-ad1c-f0154b924537"; // modul-arab-syam-101-id
