...
// "Tiếng Việt 101 new edition" A2 · B1 · B2 — pola sama dengan A1
// (scripts/harga-tieng-viet-101-langganan.mjs): 6 bln 79rb / 12 bln 149rb / selamanya 249rb.
//
// Slug baru semua (Vietnam belum pernah punya baris A2/B1/B2 — edisi lama "modul-vietnam-101-en" A1-B1 tetap sendiri), jadi tak ada tier
// warisan yang perlu diarsipkan. Produk dicari lewat slug, aman dijalankan ulang.
//
// Pakai: node scripts/harga-tieng-viet-102-104-langganan.mjs [slug …]
// Kembarannya dalam SQL: sql/20260924-harga-tieng-viet-102-104-langganan.sql
...
const SLUG = process.argv.slice(2).length
  ...
  : ["tieng-viet-102-a2-id", "tieng-viet-103-b1-id", "tieng-viet-104-b2-id"];
