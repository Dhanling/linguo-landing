#!/usr/bin/env node
// [harga-new-edition-langganan-v1] Menjadikan harga "Français 101 new edition"
// berformat langganan, sama seperti Japanese 101, Spanish 101, English 101,
// Deutsch 101, Mandarin 101 & Italiano 101 new edition.
//
// Baris "Lifetime Rp99.000" adalah warisan baris katalog modul Prancis lama
// (slug modul-prancis-101-id dipakai ulang oleh edisi baru). Baris itu
...
//
// Pakai: node scripts/harga-francais-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260823-harga-francais-101-langganan.sql
...
const PID = "294f32f3-7411-4bd4-bcb8-0fa330ddca24"; // modul-prancis-101-id
const TIER_LAMA = "c4195a23-8fdc-4162-afb2-7ededb96eab0"; // Lifetime Rp99.000
