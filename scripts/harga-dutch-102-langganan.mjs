...
// "Dutch 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// Dutch 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug dutch-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-dutch-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-dutch-102-langganan.sql
...
const PID = "a0ac0e87-427f-4613-bcf1-ad649ce73a4d"; // dutch-102-a2-id
