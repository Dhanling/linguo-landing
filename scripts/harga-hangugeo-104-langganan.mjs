...
// "한국어 104 new edition" (tingkat B2) — harganya disamakan persis dengan
// 한국어 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B2 ini baris katalognya BARU (slug hangugeo-104-b2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-hangugeo-104-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-hangugeo-104-langganan.sql
...
const PID = "af2281de-197a-4d0d-ba96-45d61104bfc0"; // hangugeo-104-b2-id
