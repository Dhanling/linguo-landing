...
// "Egyptian Arabic 101 new edition" — pola yang sama dengan Japanese, Spanish, English,
// Dansk, German, Italiano, Norsk, Suomi, Georgian, Uzbek, Myanmar, Khmer & Eesti 101.
//
// Modul ini memakai pola Khmer/Georgian, bukan pola Français/English: katalog
// BELUM pernah punya baris bahasa Arab Mesir sama sekali (dicek 27 Agu 2026 —
// pencarian slug/title/language berisi "egypt"/"mesir" cuma menemukan produk
// Arab Fusha `modul-arab-101-id` dan `modul-arab-101-en`, dua produk berbeda
// yang sengaja tidak disentuh), jadi tak ada tier warisan yang perlu
// diarsipkan dan tak ada pembeli lama yang bisa terganggu.
//
// Pakai: node scripts/harga-arab-mesir-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260827-harga-arab-mesir-101-langganan.sql
...
const PID = "93236808-4a6a-4b38-8355-2ff101bc58b8"; // modul-arab-mesir-101-id
