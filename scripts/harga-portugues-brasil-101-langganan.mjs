...
// "Português do Brasil 101 new edition" — pola yang sama dengan Japanese,
// Spanish, English, German, Italiano, Mandarin, Français, Dansk, Korean,
// Russian, Magyar, Georgian, Vietnam & Íslenska 101 new edition.
//
// Baris katalognya BARU (modul-portugues-brasil-101-id) — bukan warisan modul
// lama — jadi tak ada tier "Lifetime Rp99.000" yang perlu diarsipkan. Baris
// warisan `modul-portugis-101-id` sengaja TIDAK disentuh: modul itu bahasa
// Portugis Eropa, produk yang berbeda.
//
// Pakai: node scripts/harga-portugues-brasil-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-portugues-brasil-101-langganan.sql
...
const PID = "0e452d4b-9b90-4a96-b00f-dfc19b6d3de8"; // modul-portugues-brasil-101-id
