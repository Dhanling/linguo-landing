...
// "한국어 103 new edition" (tingkat B1) — harganya disamakan persis dengan
// 한국어 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B1 ini baris katalognya BARU (slug hangugeo-103-b1-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-hangugeo-103-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-hangugeo-103-langganan.sql
...
const PID = "91bf7b63-4fdb-4540-adfc-c3d82d239617"; // hangugeo-103-b1-id
