...
// "Urdu 101 new edition" — pola yang sama dengan Japanese, Spanish, English,
// Dansk, German, Italiano, Norsk, Suomi, Nederlands, Georgian, Hindi, Farsi &
// Greek 101 new edition.
//
// Katalog SAMA SEKALI belum punya produk berbahasa Urdu — tidak ada
// `modul-urdu-101-en` maupun baris warisan "Lifetime Rp99.000" yang perlu
// diarsipkan. Produknya di-INSERT oleh ebook-publish, dan skrip ini murni
// memasang tiga tier baru.
//
// Pakai: node scripts/harga-urdu-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260825-harga-urdu-101-langganan.sql
...
const PID = "09f87ac2-fdbc-47b1-83b6-f152be34adbb"; // modul-urdu-101-id
