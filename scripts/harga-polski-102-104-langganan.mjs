...
// "Polski 101 new edition" A2 · B1 · B2 — pola sama dengan A1
// (scripts/harga-polski-101-langganan.mjs): 6 bln 79rb / 12 bln 149rb / selamanya 249rb.
//
// Slug baru semua (Polandia belum pernah punya baris A2/B1/B2 — edisi lama "modul-polandia-101-en" A1-B1 tetap sendiri), jadi tak ada tier
// warisan yang perlu diarsipkan. Produk dicari lewat slug, aman dijalankan ulang.
//
// Pakai: node scripts/harga-polski-102-104-langganan.mjs [slug …]
// Kembarannya dalam SQL: sql/20260923-harga-polski-102-104-langganan.sql
...
const SLUG = process.argv.slice(2).length
  ...
  : ["polski-102-a2-id", "polski-103-b1-id", "polski-104-b2-id"];
