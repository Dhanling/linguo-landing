...
// "Indonesian 101 new edition" — pola yang sama dengan Japanese, Spanish,
// English, German, Italiano, Mandarin, Français, Dansk, Korean, Russian,
// Magyar, Georgian, Vietnam, Íslenska, Tagalog & Português do Brasil.
//
// Ini modul BIPA pertama: bahasa yang dipelajari justru bahasa Indonesia dan
// pengantarnya bahasa Inggris, jadi baris katalognya baru sama sekali
// (indonesian-101-a1-en) dan tak ada tier warisan yang perlu diarsipkan.
//
// Pakai: node scripts/harga-indonesian-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-indonesian-101-langganan.sql
...
const PID = "289818ef-29a8-4d56-b52d-00c52954bd1d"; // indonesian-101-a1-en
