...
// "Pashto 101 new edition" — pola yang sama dengan Japanese, Spanish, English,
// Dansk, German, Italiano, Norsk, Suomi, Georgian, Uzbek, Myanmar, Khmer, Eesti & Mongolia 101.
//
// Modul ini memakai pola Khmer/Georgian, bukan pola Français/English: katalog
// BELUM pernah punya baris bahasa Pashto sama sekali (dicek 27 Agu 2026 —
// pencarian slug/title/language berisi "pas" atau "afgha" tak menemukan apa pun), jadi
// tak ada tier warisan yang perlu diarsipkan dan tak ada pembeli lama yang
// bisa terganggu.
//
// Pakai: node scripts/harga-pashto-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260827-harga-pashto-101-langganan.sql
...
const PID = "4492e363-6de4-4796-aed5-1cb741624c1a"; // modul-pashto-101-id
