...
// "English 104 new edition" (tingkat B2) — harganya disamakan persis dengan
// English 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B2 ini baris katalognya BARU (slug english-104-b2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-english-104-langganan.mjs
// Kembarannya dalam SQL: sql/20260826-harga-english-104-langganan.sql
...
const PID = "82777b58-4a8a-4c0d-bc68-be537af74a97"; // english-104-b2-id
