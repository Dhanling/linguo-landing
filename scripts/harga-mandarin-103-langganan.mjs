...
// "Mandarin 103 new edition" (tingkat B1) — harganya disamakan persis dengan
// Mandarin 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B1 ini baris katalognya BARU (slug mandarin-103-b1-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-mandarin-103-langganan.mjs
// Kembarannya dalam SQL: sql/20260828-harga-mandarin-103-langganan.sql
...
const PID = "be33966a-dfad-4aa8-8ca9-ea88c582be95"; // mandarin-103-b1-id
