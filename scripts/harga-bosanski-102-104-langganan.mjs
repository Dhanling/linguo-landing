...
// "Bosanski 101 new edition" A2 · B1 · B2 — pola sama dengan A1
// (scripts/harga-bosanski-101-langganan.mjs): 6 bln 79rb / 12 bln 149rb / selamanya 249rb.
//
// Slug baru semua (Bosnia belum pernah punya baris A2/B1/B2), jadi tak ada tier
// warisan yang perlu diarsipkan. Produk dicari lewat slug, aman dijalankan ulang.
//
// Pakai: node scripts/harga-bosanski-102-104-langganan.mjs [slug …]
// Kembarannya dalam SQL: sql/20260923-harga-bosanski-102-104-langganan.sql
...
const SLUG = process.argv.slice(2).length
  ...
  : ["bosanski-102-a2-id", "bosanski-103-b1-id", "bosanski-104-b2-id"];
