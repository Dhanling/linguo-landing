...
// "Italian 103 new edition" (tingkat B1) — harganya disamakan persis dengan
// Italian 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul B1 ini baris katalognya BARU (slug italiano-103-b1-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-italiano-103-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-italiano-103-langganan.sql
...
const PID = "fe39561e-e38f-4419-8b74-d8794e86243a"; // italiano-103-b1-id
