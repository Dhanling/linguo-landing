...
// "Hindi 101 new edition" — pola yang sama dengan Japanese, Spanish, English, Dansk,
// German, Italiano, Norsk, Suomi, Nederlands & Georgian 101 new edition.
//
// Baris ID-nya BARU: katalog cuma punya `modul-hindi-101-en` (edisi Inggris,
// masih placeholder berisi link Google Drive) dan tak pernah punya
// `modul-hindi-101-id`. Jadi produknya di-INSERT oleh ebook-publish, dan skrip
...
//
// Pakai: node scripts/harga-hindi-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-hindi-101-langganan.sql
...
const PID = "31cbfa71-1621-4695-90ce-6788c7ee3295"; // modul-hindi-101-id
