...
// "한국어 102 new edition" (tingkat A2) — harganya disamakan persis dengan
// 한국어 101 new edition, supaya pembeli tidak melihat lompatan harga saat
// naik level.
//
// Modul A2 ini baris katalognya BARU (slug hangugeo-102-a2-id), jadi tak ada
// tier warisan yang perlu diarsipkan. Skrip ini murni memasang tiga tier baru.
//
// Pakai: node scripts/harga-hangugeo-102-langganan.mjs
// Kembarannya dalam SQL: sql/20260829-harga-hangugeo-102-langganan.sql
...
const PID = "439bbbe3-529c-4489-bfc2-eac85e7dfbca"; // hangugeo-102-a2-id
