...
// "ภาษาไทย 101 new edition" — pola yang sama dengan Japanese, Spanish, English,
// German, Italiano, Mandarin, Français, Dansk, Korean, Georgian & Magyar.
//
// Berbeda dari saudara-saudaranya, baris katalog Thai ini BUKAN warisan modul
// lama: slug modul-thai-101-id baru dibuat oleh ebook-publish.mjs, jadi tidak
// ada tier "Lifetime Rp99.000" yang perlu diarsipkan. Skrip ini cuma memasang
// tiga tier langganannya.
//
// Pakai: node scripts/harga-thai-101-langganan.mjs
// Kembarannya dalam SQL: sql/20260824-harga-thai-101-langganan.sql
...
const PID = "a24e1b06-80e0-464a-9026-835ad12eadf5"; // modul-thai-101-id
