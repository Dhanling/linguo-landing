-- [harga-new-edition-langganan-v1] Harga langganan "Brazilian Portuguese 101 new edition" A2 · B1 · B2.
-- Kembaran SQL dari scripts/harga-portugues-brasil-102-104-langganan.mjs — jalankan salah satu, bukan dua-duanya.
--
-- Produk (slug baru, tanpa tier warisan):
--   portugues-brasil-102-a2-id (8e464952-33ed-4a99-bc1c-4f3c99726c86)
--   portugues-brasil-103-b1-id (172b4c53-4b69-4f9e-b3aa-1bcade3bd996)
--   portugues-brasil-104-b2-id (ea748a99-d9cf-4cc3-a5c5-f4b92129c804)
...
where p.slug in ('portugues-brasil-102-a2-id', 'portugues-brasil-103-b1-id', 'portugues-brasil-104-b2-id')
  and not exists (
