-- [harga-new-edition-langganan-v1] Harga langganan "Arabic 101 new edition" (Fusha) A2 · B1 · B2.
-- Kembaran SQL dari scripts/harga-arabic-102-104-langganan.mjs — jalankan salah satu, bukan dua-duanya.
--
-- Produk (slug baru, tanpa tier warisan):
--   arabic-102-a2-id (1e227fae-21cc-43c4-8de3-67d9a7c6eda3)
--   arabic-103-b1-id (feb2171f-2ce0-4043-a008-a5e2e6ea77d7)
--   arabic-104-b2-id (906cfaa3-4546-4a58-bc46-0d6aa234d4c1)
...
where p.slug in ('arabic-102-a2-id', 'arabic-103-b1-id', 'arabic-104-b2-id')
  and not exists (
