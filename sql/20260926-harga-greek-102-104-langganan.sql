-- [harga-new-edition-langganan-v1] Harga langganan "Greek 101 new edition" A2 · B1 · B2.
-- Kembaran SQL dari scripts/harga-greek-102-104-langganan.mjs — jalankan salah satu, bukan dua-duanya.
--
...
where p.slug in ('greek-102-a2-id', 'greek-103-b1-id', 'greek-104-b2-id')
  and not exists (
