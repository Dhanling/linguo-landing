-- [harga-new-edition-langganan-v1] Harga langganan "Turkish 101 new edition" A2 · B1 · B2.
-- Kembaran SQL dari scripts/harga-turkce-102-104-langganan.mjs — jalankan salah satu, bukan dua-duanya.
--
...
where p.slug in ('turkce-102-a2-id', 'turkce-103-b1-id', 'turkce-104-b2-id')
  and not exists (
