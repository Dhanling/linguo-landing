-- [harga-new-edition-langganan-v1] Harga langganan "Hungarian 101 new edition" A2 · B1 · B2.
-- Kembaran SQL dari scripts/harga-magyar-102-104-langganan.mjs — jalankan salah satu, bukan dua-duanya.
--
...
where p.slug in ('magyar-102-a2-id', 'magyar-103-b1-id', 'magyar-104-b2-id')
  and not exists (
