...
import StudentShell, { type AkunTab } from "@/components/akun/StudentShell"; // [linguo-patch:lms-catalog-shell-v1]
...
const TEAL = "#16796E"; // [linguo-patch:lms-catalog-shell-v1] samain palet /akun
...
export default function BelajarPage() {
  ...
  // nav-rail di sub-route catalog: balik ke /akun dgn tab kepilih
  ...
  if (loading) {
    ...
    inner = (
      <>
        {/* Hero */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#16796E] to-[#0F5A52] p-5 text-white shadow-md shadow-teal-200/40 sm:p-6">
          <div
                            ...
                            <ul className="border-t border-slate-100">
                              {lessons.map((l) => {
                                ...
                                return locked ? (
                                  ...
                                  >
                                    <a href={`/akun/belajar/${l.id}`}>{inner2}</a>
                                  </li>
                                );
                              })}
                            </ul>
  ...
  return (
    <StudentShell active="materi" onTabChange={goTab}>
      {/* [linguo-patch:lms-catalog-shell-v1] scroll-container sendiri krn panel materi overflow-hidden */}
