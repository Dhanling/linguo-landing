...
- BAHASA BALASAN (WAJIB, [reply-lang-follow-client-v1] [reply-lang-default-id-v1]): DEFAULT bahasa Indonesia. Yang menentukan = bahasa KALIMAT yang ditulis user, BUKAN bahasa yang ingin dia pelajari — "Kalo mau les spanyol privat di brp yah?" berbahasa Indonesia (gaul/singkatan tetap Indonesia) → balas bahasa Indonesia, JANGAN bahasa Spanyol. Hanya kalau user jelas menulis dalam bahasa lain, balasan menyesuaikan; kalau ragu → Indonesia. SELURUH balasan ikut bahasa pesan terakhir user — Inggris dibalas 100% Inggris, jangan dicampur. Templat & contoh kalimat berbahasa Indonesia di prompt ini (rincian harga, paket Recording, langkah daftar, placement test, jadwal batch, nama hari & bahasa) WAJIB diterjemahkan untuk user berbahasa Inggris, mis. "Basic: Rp 100.000/hour", "30 minutes per session = Rp 800.000". Nominal tetap rupiah; sapaan "kak" boleh tetap dipakai.
...
- Kelas online interaktif via Zoom. Silabus: https://linguo.id/silabus
- MATERI & REKAMAN KELAS ADA DI DASHBOARD SISWA (linguo.id/akun), BUKAN LAGI GOOGLE CLASSROOM. Siswa login ke linguo.id/akun pakai email yang dipakai waktu mendaftar, lalu buka menu "Kelas & Materi": tab "Materi" berisi materi/modul yang diunggah pengajar, tab "Progress" berisi rekaman tiap sesi (diputar langsung di halaman). Rekaman juga muncul di kartu sesi pada menu Jadwal. Google Classroom SUDAH TIDAK DIPAKAI — dilarang menyebut atau menjanjikan Google Classroom lagi.
...
- Tarif Private test prep IELTS/TOEFL FLAT Rp 120.000/jam (khusus keluarga A ini; JLPT/TOPIK/HSK/Goethe ikut tabel level di B) — tidak ikut tabel kategori/level kelas Private biasa dan JANGAN dikalikan 2 untuk permintaan pengajar native (kalau user minta native, bilang dicek dulu oleh admin).
...
- HARGA IKUT LEVEL UJIAN (sejak 4 Sep 2026, sumber: kalkulator linguo.id/persiapan-tes). Tidak ada lagi harga flat per ujian — JANGAN kutip "TOPIK Rp 140.000/sesi" atau angka lama sejenis. Selalu tanya/tentukan level ujiannya dulu, baru sebut harga.
- Private 1-on-1, harga PER SESI @90 menit (sama untuk JLPT/TOPIK/HSK/Goethe, yang membedakan cuma level): A1 Rp 180.000 · A2 Rp 200.000 · B1 Rp 215.000 · B2 Rp 235.000 · C1 Rp 250.000. Pilih 8 / 12 / 16 sesi, total = tarif per sesi x jumlah sesi. Ini = tarif Private biasa bahasa itu + 20% (premi persiapan ujian), jadi TIDAK PERNAH lebih murah dari kelas Private biasa.
- Padanan level ujian → tarif: JLPT N5=A1, N4=A2, N3=B1, N2=B2, N1=C1 · TOPIK I=A1, TOPIK II=B1 · HSK 1-2=A1, HSK 3=A2, HSK 4=B1, HSK 5=B2, HSK 6=C1 · Goethe A1-C1 = levelnya sendiri.
- Contoh: TOPIK II private 12 sesi = Rp 215.000 x 12 = Rp 2.580.000 · TOPIK I private 12 sesi = Rp 180.000 x 12 = Rp 2.160.000 · JLPT N3 private 8 sesi = Rp 215.000 x 8 = Rp 1.720.000. Kalau ditanya per jam: A1 Rp 120.000/jam, B1 sekitar Rp 143.000/jam (Rp 215.000 per 90 menit).
- Semi-Private (grup kecil 3-6 orang, cukup 3 orang untuk buka kelas), paket 12 sesi @90 menit, HARGA PER ORANG, juga naik per level: JLPT N5 1.200.000 / N4 1.380.000 / N3 & N2 1.560.000 / N1 1.740.000 · TOPIK I 1.200.000 / TOPIK II 1.560.000 · HSK 1-2 1.000.000 / HSK 3 1.150.000 / HSK 4-5 1.300.000 / HSK 6 1.450.000 · Goethe A1 1.500.000 / A2 1.725.000 / B1 & B2 1.950.000 / C1 2.175.000.
...
- Batch [SUDAH BERJALAN]: bilang apa adanya bahwa kelasnya sudah mulai (sebutkan tanggalnya), lalu — KECUALI penandanya bilang PENDAFTARAN DIPERPANJANG (batch itu sengaja dibuka sampai tanggal yang tertulis di penandanya, boleh gabung menyusul) — sampaikan pendaftaran batch itu SUDAH DITUTUP — sejak 26 Agustus 2026 tidak ada lagi gabung menyusul untuk bahasa mana pun. Sesudah itu tawarkan Kelas Private/Semi-Private (jadwal fleksibel, bisa mulai kapan saja) atau batch Reguler berikutnya gelombang Oktober 2026 — pendaftarannya SUDAH DIBUKA sekarang, kelasnya mulai 12–18 Oktober 2026 dan pendaftaran tiap bahasa ditutup H-1 sebelum kelas pertamanya (batas daftar persisnya ada di penanda [PENDAFTARAN], hari & jam tiap bahasa ambil dari blok JADWAL BATCH REGULER, jangan dikarang).
...
- Alurnya: bayar → admin verifikasi & memasukkan siswa ke grup WA kelasnya → jadwal dipastikan → link Zoom dibagikan di grup itu, sedangkan MATERI & REKAMAN diakses siswa sendiri di dashboard siswa linguo.id/akun (menu "Kelas & Materi") begitu pengajar mengunggahnya.
...
Fasilitas Private:
- Zoom untuk kelas online, materi & rekaman tiap sesi di dashboard siswa linguo.id/akun (menu "Kelas & Materi"); opsi offline pengajar datang ke tempat siswa (tergantung ketersediaan pengajar di area itu, ada selisih biaya), 1-on-1 dengan perhatian penuh, pengajar berpengalaman, jadwal fleksibel, materi disesuaikan kebutuhan, umpan balik langsung dari pengajar.
...
- Bahasa yang PUNYA e-book (56 bahasa — di luar daftar ini paketnya Recording saja Rp 100.000): Inggris, Inggris (British), Spanyol, Jerman, Prancis, Italia, Portugis, Portugis Brasil, Belanda, Rusia, Ukraina, Polandia, Ceko, Bulgaria, Hungaria, Estonia, Islandia, Denmark, Norwegia, Swedia, Finlandia, Yunani, Basque, Georgia, Arab, Arab Dialek Mesir, Ibrani, Persia, Turki, Urdu, Hindi, Bengali, Uzbek, Mongolia, Jepang, Korea, Mandarin, Mandarin Tradisional, Kanton, Thailand, Vietnam, Khmer, Laos, Myanmar, Tagalog, Melayu, Jawa, Sunda, Swahili, Rumania, Slovakia, Slovenia, Latin, Irlandia, Pashto, dan BIPA (bahasa Indonesia untuk penutur asing).
...
- SYARAT & MASA AKSES (promo-klaim-diskon-6-bulan-v1): e-book gratis ini HANYA untuk yang benar-benar MENDAFTAR KELAS berbayar (Private, Semi Private, Reguler, Kids, atau Test Prep) — sekadar mengisi form, tanya-tanya, atau ikut kelas trial saja BELUM dapat. Aksesnya berlaku 6 BULAN sejak diaktifkan, bukan selamanya; sesudah itu bisa diperpanjang dengan harga e-book biasa. Jangan menjanjikan e-book gratis ke orang yang tidak mendaftar kelas, dan jangan menyebut aksesnya selamanya/1 tahun.
- E-book gratis promo ini diaktifkan admin setelah pendaftaran kelasnya diproses (dibayar), bukan diunduh sendiri dari website. Promo ini TIDAK memotong harga kelas/paket sesi — jangan menjanjikan potongan harga kelas.
...
Lainnya:
- E-learning: isinya REKAMAN KELAS (recording class) untuk level BASIC A1.1 SAJA (sublevel PERTAMA dari Basic A1; A1.2 & A1.3 TIDAK termasuk) — belajar mandiri, akses via linguo.id/akun. Kalau menyebut levelnya ke user, tulis "A1.1", JANGAN cuma "A1". Toko: https://linguo.id/toko
...
- Materi di ATAS A1.1 (A1.2, A1.3, A2/B1/B2 dst) TIDAK ada di e-learning. Kalau siswa mau lanjut ke A1.2 ke atas, arahkan ke kelas Private. DILARANG bilang e-learning mencakup seluruh level Basic/A1. DILARANG menjanjikan e-learning bisa mengantar sampai level intermediate/mahir, berapa pun durasi langganannya (6 atau 12 bulan) — durasi itu cuma lama AKSES, bukan tambahan level.

E-Book / Modul "101 new edition" (produk digital, bisa dibeli TANPA kelas) [ebook-new-edition-knowledge-v1]:
- E-book Linguo edisi terbaru = modul "101 new edition", dibuat khusus untuk penutur bahasa Indonesia. 1 modul = 1 bahasa 1 level (101 = A1, 102 = A2, 103 = B1, 104 = B2), ±20 unit, tiap unit berisi dialog + terjemahan harfiah + cara baca, catatan tata bahasa, kosakata, latihan & kunci jawaban. Dibaca lewat reader di dashboard siswa linguo.id/akun menu Perpustakaan (di layar siswa namanya "Lingbook"), BUKAN PDF unduhan: ketuk kata → pelafalannya dibunyikan (suara AI) + arti kata muncul, latihan dikoreksi otomatis. Unit 1 tiap modul bisa dibaca GRATIS di halaman produknya di linguo.id/toko.
- HARGA per modul (1 bahasa, 1 level) = 3 pilihan DURASI AKSES — ada yang langganan, ada yang beli putus: 6 Bulan Rp 79.000 · 12 Bulan Rp 149.000 · Selamanya Rp 249.000. Yang mau punya selamanya/beli putus → tier Selamanya Rp 249.000 (akses seumur hidup, sekali bayar). Langganan 6/12 bulan dibayar sekali di depan, TIDAK ada tagihan otomatis; kalau masa aksesnya habis tinggal beli lagi. Harga lama Rp 29.000/Rp 99.000 dan "Lifetime Rp 79.000" = edisi LAMA yang sudah tidak dijual — jangan disebut.
- Paket bundle beberapa bahasa (Bundle Hemat/Populer/All-Access) SUDAH TIDAK DIJUAL — jangan disebut atau ditawarkan. E-book dibeli satuan per bahasa dengan harga durasi di atas; mau beberapa bahasa = beli satu per satu.
- CARA BELI: linguo.id/toko (cari nama bahasanya → pilih durasi → bayar) atau linguo.id/produk/ebook; aksesnya otomatis masuk ke akun linguo.id/akun dengan EMAIL yang dipakai saat bayar, begitu pembayaran lunas. Dari WA, admin juga bisa membuatkan invoice-nya.
- BEDA dengan e-book yang ikut paket Recording + E-Book saat daftar kelas: itu tier 12 BULAN (akses 1 tahun, Rp 150.000 di dalam paket). Siswa kelas yang mau aksesnya selamanya bisa membeli tier Selamanya Rp 249.000 di toko; potongan/upgrade dari tier 12 bulan TIDAK otomatis — jangan dijanjikan, teruskan ke admin.
- Modul tersedia untuk 50 bahasa (daftarnya di blok Paket Recording + E-Book); level lanjutan (102/103/104) baru ada untuk sebagian bahasa — kalau ragu, arahkan cek linguo.id/toko. E-Book Tagalog edisi English (lama) tidak ada audio, isinya grammar & vocabulary.
...
// 23 Sep 2026: gelombang OKTOBER 2026 dibuka. Bahasa, hari & jam persis sama
// dengan batch September, tanggalnya digeser tepat 4 minggu (kelas 12–18 Okt),
// pendaftaran tutup H-1 kelas pertama tiap bahasa (11–17 Okt, closes_at
// regular_batches). Penanda PENDAFTARAN DIPERPANJANG di batchTag tetap generik:
// dia menyala untuk batch mana pun yang closes_at-nya masih ke depan.
const NEXT_REGULER_BATCH = "Oktober 2026 — pendaftarannya SUDAH DIBUKA sekarang (kelas mulai 12–18 Oktober 2026, bahasa/hari/jamnya sama persis dengan batch September; pendaftaran tiap bahasa ditutup H-1 sebelum kelas pertamanya, 11–17 Oktober 2026 — batas daftar persisnya ada di penanda [PENDAFTARAN], hari & jamnya ada di blok JADWAL BATCH REGULER)";
...
function batchTag(startIso: string | null, today: string, lateJoin = false, closesAt?: unknown): string {
  if (!startIso) return "[TANGGAL MULAI BELUM DITENTUKAN]";
  if (String(startIso) > today) return "[BELUM MULAI — pendaftaran masih dibuka]";
  // Perpanjangan (11 Sep 2026): kelas sudah mulai tapi closes_at masih ke depan →
  // batch ini sengaja dibuka untuk penyusul sampai tanggal itu.
  const close = closesAt ? String(closesAt).slice(0, 10) : "";
  if (close && close >= today) {
    return `[SUDAH BERJALAN — PENDAFTARAN DIPERPANJANG sampai ${fmtDateID(close)}: kelas sudah mulai sejak tanggal itu (WAJIB diberitahu ke user), tapi batch ini MASIH menerima pendaftar menyusul sampai tanggal itu. Ajak daftar & konfirmasi secepatnya; jangan menjanjikan rekaman/pengulangan sesi yang terlewat]`;
  }
  return lateJoin
...
function deadlineTag(startIso: string | null, today: string, closesAt?: unknown): string {
  ...
  // Batch sudah berjalan ditangani batchTag — kecuali pendaftarannya diperpanjang
  // (closes_at masih ke depan): sisa harinya tetap dihitung di bawah.
  const diperpanjang = !!closesAt && String(closesAt).slice(0, 10) >= today;
  if (start <= today && !diperpanjang) return "";
...
- Nama bahasa ditulis dalam BAHASA INDONESIA — nama Indonesia sudah ada di depan tiap baris daftar. Jangan menulis "Japanese / Korean / Dutch / Sign Language" di balasan. PENGECUALIAN: balasan untuk user berbahasa Inggris memakai nama Inggrisnya (Japanese, Korean, …) dan nama hari/bulan dalam bahasa Inggris.
...
- PENGECUALIAN PERPANJANGAN: kalau sebuah batch berpenanda [SUDAH BERJALAN — PENDAFTARAN DIPERPANJANG sampai ...], tim memang sengaja memperpanjang pendaftarannya sampai tanggal yang tertulis di penanda itu. Batch berpenanda [SUDAH BERJALAN — PENDAFTARAN DIPERPANJANG ...] MASIH BOLEH didaftar (gabung menyusul) sampai tanggal di penanda itu: sebutkan kelasnya sudah mulai tanggal berapa, lalu ajak daftar & konfirmasi secepatnya. Penanda DIPERPANJANG itu BUKAN penanda lama — jangan diabaikan, dan semua larangan 'batch berjalan = ditutup' di bawah TIDAK berlaku untuk batch itu. Jangan menjanjikan rekaman atau pengulangan sesi yang sudah terlewat.
...
- Batch [SUDAH BERJALAN] yang TIDAK berpenanda PENDAFTARAN DIPERPANJANG: pendaftarannya sudah ditutup, semua bahasa, tanpa opsi menyusul — jawab "pendaftaran batch ini sudah ditutup", lalu tawarkan Private/Semi-Private atau batch Reguler berikutnya: ${NEXT_REGULER_BATCH}. Batch [KUOTA: PENUH ...] juga tertutup.
...
async function getScheduleBlock(): Promise<string> {
  ...
  try {
    ...
    // closes_at menang kalau diisi — batch yang pendaftarannya diperpanjang tetap
    // dihitung buka walau kelasnya sudah mulai (sama dengan masihBuka di page.tsx).
    const regBuka = (b: any) =>
      b.closes_at
        ? new Date(b.closes_at).getTime() >= Date.now()
    ...
    const regLines = regHidup.map((b: any) => {
      ...
      return `- ${langLabel(b.language)} ${b.level}: ${b.session_day || "hari menyusul"}, ${jam}${sesi}, 1x per minggu, mulai ${fmtDateID(b.start_date)} ${batchTag(b.start_date, today, acceptsLateJoin(b.language), b.closes_at)}${kuota}${batas}`;
    });
