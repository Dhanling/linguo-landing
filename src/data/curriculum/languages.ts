...
export const languages: LanguageMeta[] = [
  ...
  { slug: "bosnian",    name: "Bosnia",    nativeName: "Bosanski",    flag: "🇧🇦", region: "european", available: true,  description: "Bahasa resmi Bosnia dan Herzegovina — saling paham dengan Kroasia, Serbia & Montenegro, jadi satu bahasa membuka empat negara. Ejaan fonemis (tulis seperti diucapkan), 30 huruf, tujuh kasus, aspek kata kerja, dan ratusan serapan Turki (čaršija, komšija, sevdah) yang akrab di telinga Indonesia.", aliases: ["bosnia","bosnian","bosanski","bosnia herzegovina","bosnia dan herzegovina","bosna","bih","sarajevo","bosniak"] }, // linguo-patch:silabus-bosnian-v1
